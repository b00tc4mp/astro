...
describe('Endpoints de sesiones', () => {
    ...
    test('Should respond with status 200 creating a new user or a 401 if de user already exists', async () => {
    ...
    test('Should respond with status 200 when making a POST request to login a session', async () => {
        const loginData = {
          email: 'as@as.com',
          password: '123123',
    ...
    const response = await request(app)
        ...
        .set('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.')
